  ...
  <section id="about" class="about">
    <div class="container" data-aos="fade-up">
      ...
      <div class="row content">
        <div class="col-lg-6">
          <p>
            kami adalah solusi dari segala keresahan pada hunian anda.
          </p>
          <ul>
            <li><i class="ri-check-double-line"></i> kami bekerja dengan integritas</li>
            <li><i class="ri-check-double-line"></i> kami bekerja demi kepuasan konsumen kami</li>
            <li><i class="ri-check-double-line"></i> Ullamco laboris nisi ut aliquip ex ea commodo consequat</li>
          </ul>
        </div>
        <div class="col-lg-6 pt-4 pt-lg-0">
          <p>
            untuk menggunakan jasa kami silahkan melakukan pendaftaran dan selamat.
          </p>
    ...
    <div class="container" data-aos="zoom-in">
      ...
      <div class="row">
        <div class="col-lg-9 text-center text-lg-left">
          ...
          <p> Hunian sesuai ekspetasi tukangku menawarkan solusi.</p>
        </div>
...
<footer id="footer">
  ...
  <div class="container footer-bottom clearfix">
    <div class="copyright">
      &copy; Copyright <strong><span>Lambang Akbar</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
